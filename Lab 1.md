...
6.	Once done, scroll down and while keeping the **Commit directly to the master branch** option selected click on **Commit Changes** button to apply the changes
